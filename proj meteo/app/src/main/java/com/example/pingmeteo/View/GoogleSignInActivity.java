...
public class GoogleSignInActivity  extends LoginActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                //.requestIdToken(getString(R.string.default_web_client_id)) BUG
                .requestEmail()
                .build();
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                //if(exp.)
                Toast.makeText(GoogleSignInActivity.this, "Google sign done", Toast.LENGTH_SHORT).show();
                firebaseAuthWithGoogle(account.getIdToken());
            } catch (ApiException e) {
                finish();
                // Google Sign In failed, update UI appropriately
                Toast.makeText(GoogleSignInActivity.this, "Google sign in failed", Toast.LENGTH_SHORT).show();
